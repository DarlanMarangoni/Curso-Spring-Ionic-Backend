package com.dmarangoni.cursomc.resources.exception;
...
//obj especial utilizado para interceptar o erro e lançar a exception
@ControllerAdvice
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> validation (MethodArgumentNotValidException e, HttpServletRequest request){		
		ValidationError err = new ValidationError(System.currentTimeMillis(), HttpStatus.UNPROCESSABLE_ENTITY.value(), "Erro de Valição", e.getMessage(), request.getRequestURI());
		//percorrendo a lista de erro para pegar o campo e a mensagem
