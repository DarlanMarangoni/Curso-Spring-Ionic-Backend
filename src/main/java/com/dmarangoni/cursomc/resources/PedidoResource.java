...
import com.dmarangoni.cursomc.services.PedidoService;
...
public class PedidoResource {
	...
	public ResponseEntity<Page<Pedido>> findPage(
			...
			@RequestParam (value="orderBy", defaultValue="instantDate")String orderBy, 
			@RequestParam (value="direction", defaultValue="DESC")String direction) {
		Page<Pedido> list = service.findPage(page, linesPePage, orderBy, direction);
